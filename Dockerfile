...
RUN cd $TOOLDIR && git clone --recursive https://github.com/jkrasting/grid_generator_container.git tools && cd tools && git checkout a453a59 && git submodule update --recursive
